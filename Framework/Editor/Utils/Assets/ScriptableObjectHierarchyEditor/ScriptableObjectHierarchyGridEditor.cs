...
namespace Framework
{
	namespace Utils
	{
		namespace Editor
		{
			public abstract class ScriptableObjectHierarchyGridEditor<TParentAsset, TChildAsset> : ScriptableObjectHierarchyEditor<TParentAsset, TChildAsset> where TParentAsset : ScriptableObject where TChildAsset : ScriptableObject
			{
				...
				protected void CenterCameraOn(ScriptableObjectHierarchyEditorObjectGUI<TParentAsset, TChildAsset> editorGUI)
				{
				...
				protected void CenterCamera()
				{
					...
					{
						Rect maxBounds = ((ScriptableObjectHierarchyEditorObjectGUI<TParentAsset, TChildAsset>)_editableObjects[0]).GetBounds();

						for (int i = 1; i < _editableObjects.Count; i++)
						{
							ScriptableObjectHierarchyEditorObjectGUI<TParentAsset, TChildAsset> editorGUI = (ScriptableObjectHierarchyEditorObjectGUI<TParentAsset, TChildAsset>)_editableObjects[i];
