...
namespace Framework
{
	namespace Utils
	{
		namespace Editor
		{
			[CustomPropertyDrawer(typeof(MaterialPerInstanceProperties.IntProperty))]
			public class MaterialPerInstanceIntPropertyDrawer : PropertyDrawer
			{
				public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
				{
					...
					switch ((MaterialPerInstanceProperties.IntProperty.ePropertySource)sourceProperty.enumValueIndex)
					{
						case MaterialPerInstanceProperties.IntProperty.ePropertySource.Constant:
							{
								SerializedProperty valueProperty = property.FindPropertyRelative("_value");
								EditorGUI.PropertyField(valueRect, valueProperty, new GUIContent("Value"));
							}
							break;
						case MaterialPerInstanceProperties.IntProperty.ePropertySource.Range:
							{
